...
func TestHandleCalcDivisionalChart_CustomVarga(t *testing.T) {
	s := newTestServer()
	args := json.RawMessage(`{
		"latitude": 51.5074,
		"longitude": -0.1278,
	...
	if err != nil {
		t.Fatalf("handleCalcDivisionalChart custom: %v", err)
	}
	if result == nil {
		t.Fatal("result is nil")
	}
...
func TestHandleCalcAshtakavarga_CustomAyanamsa(t *testing.T) {
	s := newTestServer()
	args := json.RawMessage(`{
		"latitude": 51.5074,
		"longitude": -0.1278,
	...
	if err != nil {
		t.Fatalf("handleCalcAshtakavarga custom: %v", err)
	}
	if result == nil {
		t.Fatal("result is nil")
	}
...
func TestHandleCalcYogas_CustomAyanamsa(t *testing.T) {
	s := newTestServer()
	args := json.RawMessage(`{
		"latitude": 51.5074,
		"longitude": -0.1278,
	...
	if err != nil {
		t.Fatalf("handleCalcYogas custom: %v", err)
	}
	if result == nil {
		t.Fatal("result is nil")
	}
